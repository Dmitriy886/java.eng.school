...
public class TeachingProgram {
    ...
    @ManyToMany(mappedBy = "teachingPrograms", fetch = FetchType.LAZY)
    ...
    public int getTeachings() { return teachings;
    }

    public void setTeachings(int teachings) {
